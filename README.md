...
An interactive Power BI dashboard developed to analyze Netflix’s global content library. The project provides insights into genres, ratings, countries, release trends, and distribution of movies vs TV shows using visual storytelling.

🚀 Project Overview

This project focuses on exploring and visualizing Netflix titles using Power BI.
